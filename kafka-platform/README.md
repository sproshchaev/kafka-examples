...
`2.`  Один брокер с ZooKeeper, Schema Registry, Kafka REST, Kafdrop: [docker-compose.zk-dev-full.yml](docker-compose.zk-dev-full.yml)  
...
| 4.1 | [docker-compose.kraft-1c1b-full.kafdrop.yml](docker-compose.kraft-1c1b-full.kafdrop.yml)         | `localhost:9093`                    | KRaft               | `:8081`         | `:8082`        | `http://localhost:9000`            | ❌           |
